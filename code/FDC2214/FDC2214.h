...
typedef enum
{
    FDC2214_Channel_0 = 0x00, //通道0
    FDC2214_Channel_1 = 0x01, //通道1
    FDC2214_Channel_2 = 0x02, //通道2
    FDC2214_Channel_3 = 0x03  //通道3
}FDC2214_channel_t;

//多通道模式下扫描通道
typedef enum
{
    FDC2214_Channel_Sequence_0_1      = 0x00, //通道0，1
    FDC2214_Channel_Sequence_0_1_2    = 0x01, //通道0，1，2
    FDC2214_Channel_Sequence_0_1_2_3  = 0x02, //通道0，1，2，3
}FDC2214_channel_sequence_t;

//数字滤波器带宽
typedef enum
{
    FDC2214_Bandwidth_1M   = 0x01, //1MHz带宽
    FDC2214_Bandwidth_3_3M = 0x04, //3.3MHz带宽
    FDC2214_Bandwidth_10M  = 0x05, //10MHz带宽
    FDC2214_Bandwidth_33M  = 0x07  //33MHz带宽
...
float FDC2214_CalculateFrequency(FDC2214_channel_t channel, uint32_t datax);
float FDC2214_CalculateCapacitance(float frequency, float inductance, float capacitance);
